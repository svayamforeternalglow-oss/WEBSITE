...
export const products: Product[] = [
  ...
  { slug: 'complete-radiance-kit', name: 'The Complete Radiance Kit', tagline: 'Your complete skincare ritual', description: 'A curated kit for radiant skin.', story: '', category: 'beauty-products', theme: 'beauty', price: 0, originalPrice: 0, weight: '', sku: 'SN-KIT-CRK', image: '/images/Complete-Radiance-Kit.jpeg', badges: [], ingredients: [], benefits: [] },
  ...
  { slug: 'tejasamrit-golden-latte-family-pack', name: 'Tejasamrit Golden latte family pack', tagline: 'Share the ritual', description: 'Family pack of Tejasamrit Golden latte.', story: '', category: 'beauty-products', theme: 'beauty', price: 0, originalPrice: 0, weight: '', sku: 'SN-KIT-TGL', image: '/images/Eat-To-Glow-Kit.jpeg', badges: [], ingredients: [], benefits: [] },
  ...
  { slug: 'face-polishing-scrub', name: 'Face Polishing Mask', tagline: 'Gentle exfoliation', description: 'Face polishing mask for smooth, glowing skin.', story: '', category: 'skin-care', theme: 'skincare', price: 0, originalPrice: 0, weight: '', sku: 'SN-SC-FPS', image: '/images/face-polishing-mask.jpeg', badges: [], ingredients: [], benefits: [] },
...
export const CONCERN_ROUTE_PRODUCTS: Record<string, string[]> = {
  ...
  'dry-skin': ['glowup-night-gel', 'kayashuddhi-abhyanga-body-oil', 'abhyanga-udvartana', 'abhyanga-natural-soap', 'snehchandan-natural-soap', 'triphala-natural-soap'],
