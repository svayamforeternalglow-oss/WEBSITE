...
export const products: Product[] = [
  ...
  },
  {
    ...
    weight: '150g',
    sku: 'SN-HC-HBG-150',
    image: '/images/hibiscus-night-gel.jpeg',
  ...
  },
  {
    ...
    weight: '200ml',
    sku: 'SN-WL-ABH-200',
    image: '/images/abhyanga-udvartana.jpeg',
  ...
  { slug: 'complete-radiance-kit', name: 'The Complete Radiance Kit', tagline: 'Your complete skincare ritual', description: 'A curated kit for radiant skin.', story: '', category: 'beauty-products', theme: 'beauty', price: 0, originalPrice: 0, weight: '', sku: 'SN-KIT-CRK', image: '/images/tejasamrit.png', badges: [], ingredients: [], benefits: [] },
  { slug: 'hair-care-kit', name: 'Hair care kit', tagline: 'Complete hair care solution', description: 'Everything you need for healthy hair.', story: '', category: 'hair-care', theme: 'herbal', price: 0, originalPrice: 0, weight: '', sku: 'SN-KIT-HC', image: '/images/tejasamrit.png', badges: [], ingredients: [], benefits: [] },
  ...
  { slug: 'royal-bathing-kit', name: 'Royal bathing kit', tagline: 'Luxury bath ritual', description: 'Premium bathing essentials.', story: '', category: 'wellness', theme: 'wellness', price: 0, originalPrice: 0, weight: '', sku: 'SN-KIT-RB', image: '/images/tejasamrit.png', badges: [], ingredients: [], benefits: [] },
  ...
  { slug: 'tarunya-rose-toner', name: 'Tarunya Rose Toner', tagline: 'Refreshing rose toner', description: 'Gentle rose toner for balanced skin.', story: '', category: 'skin-care', theme: 'skincare', price: 0, originalPrice: 0, weight: '', sku: 'SN-SC-TRT', image: '/images/tejasamrit.png', badges: [], ingredients: [], benefits: [] },
  { slug: 'kumkumadi-lip-balm', name: 'Kumkumadi lip balm', tagline: 'Luxury lip care', description: 'Nourishing lip balm with Kumkumadi.', story: '', category: 'beauty-products', theme: 'beauty', price: 0, originalPrice: 0, weight: '', sku: 'SN-BP-KLB', image: '/images/tejasamrit.png', badges: [], ingredients: [], benefits: [] },
